...
getAllUserOrderDetails(){
  return this.httpClient.get<any>(this.base_url+"/OrderDetail/Index").pipe(map((res:any)=>{
    return res;
  }))
}
...
getProductPage():Observable<ICustomerOrderInformation []>{
  return this.httpClient.get<ICustomerOrderInformation []>(this.base_url+"/Productpages/Index");  
}
